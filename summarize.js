...
(function() {
    ...
    function init() {
        ...
        script.onload = async () => {
            // Ensure pdfjsLib is available after loading pdf.min.js
            window.pdfjsLib = window['pdfjsLib'];
            
            // Set the workerSrc for PDF.js
            window.pdfjsLib.GlobalWorkerOptions.workerSrc = chrome.runtime.getURL('assets/pdf.worker.min.js');
        
            // Only run this after pdf.js is fully loaded and worker is set
            if (isPdfPageSync()) {
                ...
                try {
                    ...
                    // Proceed with generating summary using the extracted text
                    try {
                        ...
                        // Handle the summary response and display it
                        if (data.summary) {
        ...
        // Append the script to the document head to load pdf.min.js
